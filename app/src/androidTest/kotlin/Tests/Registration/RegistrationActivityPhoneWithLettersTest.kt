...
class RegistrationActivityPhoneWithLettersTest : TestCase(
    ...
    @Test
    fun testRegistrationWithLettersInPhone() = run {
        ...
        step("Вводим буквы вместо номера телефона") {
            onComposeScreen<RegistrationScreen>(composeTestRule) {
                phoneField.performTextInput("aaaaaaaaa")
            }
        }
