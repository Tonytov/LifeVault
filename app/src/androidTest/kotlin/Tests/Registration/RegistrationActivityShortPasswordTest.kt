...
class RegistrationActivityShortPasswordTest : TestCase(
    ...
    @Test
    fun testRegistrationWithShortPassword() = run {
        ...
        step("Вводим такой же короткий пароль в подтверждение") {
            onComposeScreen<RegistrationScreen>(composeTestRule) {
                confirmPasswordField.performTextInput("test11")
            }
        }
